...
# Fungi: Plantae OTUs
print("Fungi:", length(grep("Plantae", ubiome_FUN$taxData$kingdom)), "Plantae OTUs\n")
...
print("Bacteria: removing", length(filt), "OTUs")
...
ubiome_BAC$dds$sizeFactor <- ubiome_BAC$dds$Copy_number / mean(ubiome_BAC$dds$Copy_number,na.rm=T)
